...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public LibrariesForLibs(DefaultVersionCatalog config, ProviderFactory providers, ObjectFactory objects, ImmutableAttributesFactory attributesFactory, CapabilityNotationParser capabilityNotationParser) {
        ...
        /**
         * Creates a dependency provider for billing (com.google.android.play:billing)
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    /**
     * Returns the group of libraries at card
     */
    ...
    /**
     * Returns the group of libraries at paypal
     */
    ...
    public static class CardLibraryAccessors extends SubDependencyFactory {
        ...
        public CardLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for payments (com.paypal.android:card-payments)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getPayments() {
                return create("card.payments");
        }
    ...
    public static class PaypalLibraryAccessors extends SubDependencyFactory {
        private final PaypalAndroidLibraryAccessors laccForPaypalAndroidLibraryAccessors = new PaypalAndroidLibraryAccessors(owner);

        public PaypalLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Returns the group of libraries at paypal.android
         */
        public PaypalAndroidLibraryAccessors getAndroid() {
            return laccForPaypalAndroidLibraryAccessors;
        }

    }

    public static class PaypalAndroidLibraryAccessors extends SubDependencyFactory {

        public PaypalAndroidLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for sdk (com.paypal.sdk:paypal-android-sdk)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getSdk() {
                return create("paypal.android.sdk");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: cardPayments (CURRENT-VERSION)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getCardPayments() { return getVersion("cardPayments"); }
            ...
            /**
             * Returns the version associated to this alias: paypalAndroidSdk (2.16.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getPaypalAndroidSdk() { return getVersion("paypalAndroidSdk"); }
