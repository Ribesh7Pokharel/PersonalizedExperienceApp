...
public class Interests extends AppCompatActivity {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (listViewTopics.isItemChecked(position)) {
                    if (selectedTopics.size() >= MAX_SELECTED_TOPICS) {
                        Toast.makeText(Interests.this, "You can select maximum " + MAX_SELECTED_TOPICS + " topics", Toast.LENGTH_SHORT).show();
    ...
    public void updateUserInterest(String userId, String newInterest) {
        ...
        Intent i = new Intent(Interests.this, Dashboard.class);
