...
public class Task extends AppCompatActivity implements OnRadioButtonClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonSubmitQues.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!checkCompletion()) {
                    Toast.makeText(Task.this, "Please attempt all the questions", Toast.LENGTH_SHORT).show();
                }else {
    ...
    private class QuestionAdapter extends RecyclerView.Adapter<QuestionAdapter.TaskViewHolder> {
        ...
        public QuestionAdapter.TaskViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_question_page, parent, false);
